package com.vily.videodemo1.netty;
...
//    private ScheduledExecutorService mScheduledExecutorService;
    ...
    public void connect() {
        ...
        Thread clientThread = new Thread("client-Vily") {
            @Override
            public void run() {
                super.run();
                ...
                Bootstrap bootstrap = new Bootstrap().group(group)
                        ...
                        .handler(new ChannelInitializer<SocketChannel>() { // 5
                            ...
                            public void initChannel(SocketChannel ch) throws Exception {
                                ch.pipeline().addLast("ping", new IdleStateHandler(0, 10, 0, TimeUnit.SECONDS));//5s未发送数据，回调userEventTriggered
